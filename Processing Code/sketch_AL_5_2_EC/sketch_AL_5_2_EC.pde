/*
  This version has Opus respecting the growth of plants, with efforts
...
void setup() {
  ...
  world = new World(0, 50, 70); //refers to number of Hachi(3rd in food chain) Opus(2nd in food chain) Plants on start
